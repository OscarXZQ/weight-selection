...
class ConvNeXt(nn.Module):
    ...
    def forward_features(self, x, output_dict=False):
        x = self.stem(x)
        x = self.stages(x)
        x = self.norm_pre(x)
        if output_dict:
...
# @register_model
# def convnext_femto(pretrained=False, **kwargs): #4,871,284
#     # timm femto variant
#     model_args = dict(
#         depths=(2, 2, 6, 2), dims=(48, 96, 192, 384), conv_mlp=False, **kwargs)
#     model = _create_convnext('convnext_femto', pretrained=pretrained, **model_args)
...
# @register_model
# def convnext_femto_1(pretrained=False, **kwargs): #7,557,880
#     # timm femto variant
#     model_args = dict(
#         depths=(2, 2, 6, 2), dims=(60, 120, 240, 480), conv_mlp=False, **kwargs)
#     model = _create_convnext('convnext_femto', pretrained=pretrained, **model_args)
#     return model

@register_model
def convnext_femto_1(pretrained=False, **kwargs): #10,831,996
    # timm femto variant
    model_args = dict(
        depths=(2, 2, 6, 2), dims=(72, 144, 288, 576), conv_mlp=False, **kwargs)
    model = _create_convnext('convnext_femto', pretrained=pretrained, **model_args)
    return model

# @register_model
# def convnext_femto_3(pretrained=False, **kwargs): #12,689,374
#     # timm femto variant
#     model_args = dict(
#         depths=(2, 2, 6, 2), dims=(78, 156, 312, 624), conv_mlp=False, **kwargs)
#     model = _create_convnext('convnext_femto', pretrained=pretrained, **model_args)
#     return model

@register_model
def convnext_femto_2(pretrained=False, **kwargs): #15,780,268
    model_args = dict(depths=(3, 3, 9, 3), dims=(72, 144, 288, 576), **kwargs)
    model = _create_convnext('convnext_tiny', pretrained=pretrained, **model_args)
    return model

# @register_model
# def convnext_femto_5(pretrained=False, **kwargs): #18,488,050
#     model_args = dict(depths=(3, 3, 9, 3), dims=(78, 156, 312, 624), **kwargs)
#     model = _create_convnext('convnext_tiny', pretrained=pretrained, **model_args)
#     return model

@register_model
def convnext_femto_3(pretrained=False, **kwargs): #21,410,104
    model_args = dict(depths=(3, 3, 9, 3), dims=(84, 168, 336, 672), **kwargs)
    model = _create_convnext('convnext_tiny', pretrained=pretrained, **model_args)
    return model

# @register_model
# def convnext_femto_7(pretrained=False, **kwargs): #24,546,430
#     model_args = dict(depths=(3, 3, 9, 3), dims=(90, 180, 360, 720), **kwargs)
#     model = _create_convnext('convnext_tiny', pretrained=pretrained, **model_args)
#     return model

# @register_model
# def convnext_tiny(pretrained=False, **kwargs): #27,897,028
#     model_args = dict(depths=(3, 3, 9, 3), dims=(96, 192, 384, 768), **kwargs)
#     model = _create_convnext('convnext_tiny', pretrained=pretrained, **model_args)
#     return model
